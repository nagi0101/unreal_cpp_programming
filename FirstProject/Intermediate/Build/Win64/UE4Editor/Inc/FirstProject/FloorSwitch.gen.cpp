...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_AFloorSwitch_Statics::NewProp_SwitchTime = { "SwitchTime", nullptr, (EPropertyFlags)0x0010000000020005, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AFloorSwitch, SwitchTime), METADATA_PARAMS(Z_Construct_UClass_AFloorSwitch_Statics::NewProp_SwitchTime_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AFloorSwitch_Statics::NewProp_SwitchTime_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AFloorSwitch_Statics::NewProp_InitialFloorSwitchLocation_MetaData[] = {
		{ "Category", "Floor Switch" },
		{ "Comment", "/** Initial Location of FloorSwitch */" },
		{ "ModuleRelativePath", "FloorSwitch.h" },
		{ "ToolTip", "Initial Location of FloorSwitch" },
	};
#endif
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AFloorSwitch_Statics::NewProp_InitialDoorLocation_MetaData[] = {
		{ "Category", "Floor Switch" },
		{ "Comment", "/** Initial Location of Door */" },
		{ "ModuleRelativePath", "FloorSwitch.h" },
		{ "ToolTip", "Initial Location of Door" },
	};
#endif
	...
	IMPLEMENT_CLASS(AFloorSwitch, 754877770);
