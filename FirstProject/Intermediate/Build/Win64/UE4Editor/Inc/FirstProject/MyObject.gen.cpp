...
#include "FirstProject/MyObject.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	FIRSTPROJECT_API UClass* Z_Construct_UClass_UMyObject_NoRegister();
	FIRSTPROJECT_API UClass* Z_Construct_UClass_UMyObject();
...
// End Cross Module References
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UMyObject_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UMyObject_MyFunction, "MyFunction" }, // 1381621099
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UMyObject, 3511889364);
	template<> FIRSTPROJECT_API UClass* StaticClass<UMyObject>()
	{
		return UMyObject::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UMyObject(Z_Construct_UClass_UMyObject, &UMyObject::StaticClass, TEXT("/Script/FirstProject"), TEXT("UMyObject"), false, nullptr, nullptr, nullptr);
